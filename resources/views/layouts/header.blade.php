  ...
  <div class="mobile-main-menu-top">
    ...
    <div class="mb-menu-top-body">
      ...
      <div class="mb-menu-info">
        <div class="info-top">Login</div>
        <div class="info-bottom">To receive more incentives</div>
      </div>
    </div>
    <div class="mb-menu-top-footer">
      ...
      <div class="mb-menu-action">
        <a href="{{ route('register') }}" class="btn btn-warning">
          <i class="fas fa-key"></i> Register now
        </a>
      </div>
    </div>
    @else
  ...
  <div class="mobile-main-menu-middle">
    ...
    <div class="mb-menu-middle-body">
      <ul>
        ...
        <li class="mb-nav-item {{ Helper::check_active(['orders_page', 'order_page']) }}"><a href="{{ route('orders_page') }}"><span class="fas fa-clipboard-list"></span> Order</a></li>
        @endif
      </ul>
    </div>
  </div>
  <div class="mobile-main-menu-bottom">
    <div class="mobile-support">
      ...
      <div class="info-support">
        <i class="fa fa-phone" aria-hidden="true"></i> HOTLINE: <a href="tel: +84 94 960 5631 " title="(+84) 94 960 5631">(+84) 94 960 5631</a>
      </div>
      <div class="info-support">
        <i class="fa fa-envelope" aria-hidden="true"></i> EMAIL: <a href="mailto:immortalteam@gmail.com" title="immortalteam@gmail.com">immortalteam@gmail.com</a>
      </div>
    </div>
  </div>
</div>
